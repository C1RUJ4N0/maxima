        ...
        return {
            ...
            async fetchAPI(endpoint, options = {}) {
                ...
                try {
                    ...
                    // Aseguramos que todas las llamadas internas usen el prefijo /api
            ...
            async guardarNuevoProducto() {
                try {
                    // CORRECCIÓN PARA EL ERROR 405: 
                    // El endpoint correcto para POST de creación es '/inventario', no '/inventario/productos'.
